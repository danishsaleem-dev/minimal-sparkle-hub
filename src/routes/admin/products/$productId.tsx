...
function EditProductPage() {
  ...
  const defaultValues: Partial<ProductFormValues> = {
    ...
    variants: (data.product_variants ?? []).map((v: { id: string; title: string; sku: string | null; price: number | null; compare_price: number | null; inventory_quantity: number; available: boolean }) => ({
      id: v.id,
      title: v.title,
      sku: v.sku ?? "",
